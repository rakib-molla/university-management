...
const updateSingleAcademicDepartmentFromDB = async(_id: string, payload:Partial<TAcademicDepartment>)=>{
 const result = await AcademicDepartmentModel.findOneAndUpdate({_id: _id}, payload, {new: true});
 return result;
}
